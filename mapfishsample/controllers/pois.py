...
from mapfishsample.model import Poi
...
class PoisController(BaseController):
    ...
    def __init__(self):
        self.protocol = Protocol(Session, Poi, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Poi)
        # filter = and_(default_filter, Poi.columname.ilike('%value%'))
